...
public function exportExcelObatKeluar()
{
    ...
    $sheet->setCellValue('H3', 'Harga Total');
    $sheet->setCellValue('I3', 'Tanggal Kadaluwarsa');
    
    $sheet->getStyle('A3:I3')->getFont()->setBold(true);
    $sheet->getStyle('A3:I3')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID);
    $sheet->getStyle('A3:I3')->getFill()->getStartColor()->setARGB('FFCCCCCC');
    ...
    $sheet->getStyle('A3:I' . $totalRowNum)->applyFromArray($styleArray);
